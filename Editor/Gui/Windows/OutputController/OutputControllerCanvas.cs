...
internal sealed class OutputControllerCanvas : ScalableCanvas
{
    public OutputControllerCanvas(VirtualOutputController outputController)
    {
        ResetView();
    ...
    public void Draw(Structure? structure)
    {
        ...
        // Set correct output ui
        {
            ...
            // This is messy, dependent because draw value used output ui, which is stored in window...
            // Refactor would be needed to make this clean.
            //_outputController.OutputUi = symbolUi.OutputUis[_firstOutputSlot.Id];
        }
    ...
    private void FillInNextVariation(Structure structure)
    {
        ...
        if (_outputController.VariationParameters.Count == 0)
        {
            return;
        }
    ...
    private ExplorationVariation CreateVariationAtMouseMouse()
    {
        ...
        return ExplorationVariation.Mix(_outputController.VariationParameters, neighbours, 0);
    }
    ...
    private ExplorationVariation CreateVariationForCell(GridCell cell)
    {
        ...
        return ExplorationVariation.Mix(_outputController.VariationParameters, neighboursAndWeights, Scatter, cell);
    }
    ...
    private void RenderThumbnail(ExplorationVariation variation, Structure structure)
    {
        ...
        if(_outputController.OutputUi != null)
            _outputController.OutputUi.DrawValue(_firstOutputSlot, _thumbnailCanvasRendering.EvaluationContext, "thumbnail");
        ImGui.PopClipRect();
    ...
    private readonly VirtualOutputController _outputController;
